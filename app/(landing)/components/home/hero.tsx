    ...
    return (
        <section id="hero-section" className="container mx-auto h-screen flex">
            <div className="relative self-center ">
                <Image src="/images/img-basketball.png" width={432} height={423} alt="image basket sporton" className="grayscale absolute left-0 -top-10"/>
            ...
            <Image src="/images/img-ornament-hero.svg" width={420} height={420} alt="ornament hero sporton" className="absolute -right-[200px] top-1/2 -translate-y-1/2"/>
        </section>
    );
};
